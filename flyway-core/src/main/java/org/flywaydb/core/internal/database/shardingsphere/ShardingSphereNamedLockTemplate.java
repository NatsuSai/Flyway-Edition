...
/**
 * Spring-like template for executing with ShardingSphere named locks.
 */
public class ShardingSphereNamedLockTemplate {
    private static final Log LOG = LogFactory.getLog(ShardingSphereNamedLockTemplate.class);
     ...
     */
    ShardingSphereNamedLockTemplate(JdbcTemplate jdbcTemplate, int discriminator) {
