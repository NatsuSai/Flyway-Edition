...
/**
 * ShardingSphere implementation of Schema.
 */
public class ShardingSphereSchema extends Schema<ShardingSphereDatabase> {
    /**
     ...
     */
    ShardingSphereSchema(JdbcTemplate jdbcTemplate, ShardingSphereDatabase database, String name) {
...
//        ) == 0;
    ...
    protected Table[] doAllTables() throws SQLException {
        ...
        for (int i = 0; i < tableNames.size(); i++) {
            tables[i] = new ShardingSphereTable(jdbcTemplate, database, this, tableNames.get(i));
        }
        return tables;
    }
    ...
    public Table getTable(String tableName) {
        return new ShardingSphereTable(jdbcTemplate, database, this, tableName);
    }
}