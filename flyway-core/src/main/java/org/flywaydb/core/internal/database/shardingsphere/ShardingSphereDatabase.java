 ...
 */
package org.flywaydb.core.internal.database.shardingsphere;
 ...
 */
public class ShardingSphereDatabase extends Database<ShardingSphereConnection> {
    private static final Log LOG = LogFactory.getLog(ShardingSphereDatabase.class);
     ...
     */
    public ShardingSphereDatabase(Configuration configuration, Connection connection, boolean originalAutoCommit
    ...
    @Override
    protected ShardingSphereConnection getConnection(Connection connection



    ) {
        return new ShardingSphereConnection(configuration, this, connection, originalAutoCommit
    ...
    protected SqlStatementBuilderFactory createSqlStatementBuilderFactory(PlaceholderReplacer placeholderReplacer
        ...
        return new ShardingSphereSqlStatementBuilderFactory(placeholderReplacer);
    }
